...
![](img/img13.png) [Ссылка на
дашборд](https://datalens.ru/j2cfyqnvqmoc4-analiz-setevogo-trafika)
...
Задача решена с использованием сервис `Yandex DataLens`.Я научился
делать чарты и составлять из них дашборд \## Вывод

В данной работе я ия познакомился с сервисами Yandex DataLens, изучил
возможности технологии для построения дашбордов.
